...
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-xinetd-zh-cn"CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-mlx4-core"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES iwlwifi-firmware-ax200"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES iwlwifi-firmware-ax201"
CUSTOM_PACKAGES="$CUSTOM_PACKAGES libgphoto2-drivers-ax203"
